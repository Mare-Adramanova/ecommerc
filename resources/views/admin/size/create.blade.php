...
<div class="mt-3 ml-2" >
    ...
    <i class="fa fa-angle-right" style="font-size:24px"></i>
    <span><a href="{{ route('admin.sizes.create') }}" style="color: black; font-size: 16px; text-decoration: none">Create</a></span>
    
</div>

    <form action="{{ route('admin.sizes.store') }}" method="POST" class="was-validated mt-2 p-2">
        @csrf
